...
export default defineContentScript({
  ...
  main() {
    ...
    `;
    // Insert the custom modal HTML into the document body
    ...
    // Generate message based on user input and append to the chat
    const generateMessage = () => {
      const messages = [
        "Thank you for the opportunity! If you have any more questions or if there's anything else I can help you with, feel free to ask.",
      ];
      return messages[messageCount++ % messages.length]; // Cycles through available messages
    };
